var runLevels = function (window) {
 ...
 function  createEnemy(x, y, speed, image, offsetX, offsetY, scale){
    ...
    var redSqaure = draw.bitmap(image)
    redSqaure.x = offsetX;
    redSqaure.y = offsetY;
    redSqaure.scaleX = scale;
    redSqaure.scaleY = scale;
    enemy.addChild(redSqaure)
    enemy.x = x;
    enemy.y = y ;
  ...
  var blueSqaure = draw.bitmap("img/Juggernog.png")
    blueSqaure.x = -2;
    blueSqaure.y = -2;
    reward.addChild(blueSqaure)
    reward.x = x;
    reward.y = y ;
...
function  createMarker(x, y, speed){
    ...
    var yellowSqaure = draw.bitmap("img/staminupmarket.png")
    yellowSqaure.x = -25;
    yellowSqaure.y = -25;
    marker.addChild(yellowSqaure)
    marker.x = x;
    marker.y = y ;

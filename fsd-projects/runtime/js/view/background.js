        ...
        function render() {
            ...
            // you should modify both the height and color to suit your game
                ...
                var backgroundImage = new Image();
                 backgroundImage.src = "img/origins2background.png";
          ...
          for(var i = 0; i < 100; i++){   
            ...
            // TODO 4: Part 1 - Add buildings!     Q: This is before TODO 4 for a reason! Why?
               for (var i = 0; i < 5; i++) {
                var buildingcolors = ["black", "green", "yellow", "red", "brown"]
                var buildingHeight = 300;
                var building = draw.rect(75, buildingHeight, buildings[i], "Blue", 1);
                building.x = 200 * i;
